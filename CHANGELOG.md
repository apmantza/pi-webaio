...
- **Test layer expansion** — added `npm run test:paywall` and `npm run test:check` scripts and added both suites to `test:all`. Test count: 235 → 246 (145 unit + 31 new-features + 54 paywall + 11 github-check + 5 integration).
