...
- `npm run test:all` → runs all 73 wired suites (1547 tests total, 0 fail, 3 expected skips: a live-network Jina test that skips on external HTTP 403, and opt-in live TLS tests)
