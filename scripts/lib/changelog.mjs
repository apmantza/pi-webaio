...
/** A version heading looks like `## [0.6.1] - 2026-06-21` or `## [Unreleased]`. */
const VERSION_HEADING = /^## \[([^\]]+)\]/;

/**
 * Split a CHANGELOG into ordered sections. Each entry is the bracketed label
 * (e.g. `0.6.1`, `Unreleased`) plus the raw body between this heading and the
 ...
 * first, which is what we want for the stray `## [0.4.0] ... (previous)` dupe.
 *
...
/**
 * Normalize a tag/version to its bare semver form: `v0.6.1` -> `0.6.1`.
 ...
 *
 * @param {string} text full CHANGELOG.md contents
 * @param {string} version e.g. "0.6.1" or "v0.6.1"
 * @returns {string | null}
 */
 ...
 *
 * @param {string} text full CHANGELOG.md contents
 * @param {string} version bare semver, e.g. "0.6.1"
 * @param {string} date ISO date, e.g. "2026-07-03"
 * @returns {string}
 */
